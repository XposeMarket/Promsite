...
const capabilities = [
  {
    ...
    features: [
      "Full page navigation & interaction",
      "Network interception & response logging",
      "Structured data extraction via CSS schemas",
      "Snapshot diffing for SPA efficiency",
      "DOM element watching without polling",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Memory browsing & management",
      "Session isolation when needed",
    ],
    href: "/product",
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      "Status polling & result collection",
  ...
  },
  {
    ...
    features: [
      ...
      "Isolated job sessions",
      "Synthesis rounds for quality",
      "Result summaries & logging",
  ...
  },
  {
    ...
    features: [
      ...
      "Background & foreground dispatch",
      "Shared team workspaces",
      "2-way communication with main agent",
  ...
  },
  {
    ...
    features: [
      ...
      "Pixel color watching",
      "Macro recording & replay",
      "Click, type, scroll, keypress",
      "Window targeting & focus",
    ],
    href: "/product",
  },
];
      ...
      <Section className="pt-32 md:pt-40">
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-muted leading-relaxed">
            Prometheus ships with a full suite of execution tools — from browser
            control to desktop automation. Each capability is native, local, and
            operates with real system access.
          </p>
        </div>
      </Section>
      ...
      <Section>
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            All of this. Free for everyone.
          </h2>
          <p className="text-muted text-lg mb-8">
            No feature tiers. No per-tool pricing. Every capability ships with
            every account.
          </p>
