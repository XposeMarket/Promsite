    ...
    <>
      ...
      <Section className="pt-32 md:pt-40">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-muted leading-relaxed mb-8">
            ...
            controls your browser, manages your files, schedules tasks, and
            orchestrates multi-agent teams — all through a single conversational
            interface. It doesn't ask for permission to be useful.
          </p>
      ...
      <Section dark id="pillars">
        <div className="mb-16">
          ...
          <p className="text-muted text-lg max-w-2xl">
            Every capability in Prometheus exists to serve a single purpose:
            turning intent into executed outcome.
          </p>
        </div>
      ...
      <Section id="architecture">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Architecture built for action
          </h2>
          <p className="text-muted text-lg">
            Prometheus runs as a local gateway on your machine. Your data never
            leaves unless you tell it to. The system processes requests through
            a pipeline of planning, tool selection, execution, and verification.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="text-center">
            ...
            <p className="text-sm text-muted">
              Persistent sessions, encrypted vault, and context graph — fully
              local
            </p>
          </Card>
        </div>
      ...
      <Section dark>
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to stop asking and start executing?
          </h2>
          <p className="text-muted text-lg mb-8">
            Prometheus gives you the full system for free. No usage caps. No
            feature gates.
          </p>
          <Button size="lg" href="/pricing">
            See Pricing
